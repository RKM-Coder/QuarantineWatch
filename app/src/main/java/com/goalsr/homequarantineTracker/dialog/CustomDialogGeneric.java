...
public class CustomDialogGeneric extends Dialog {
    ...
    public CustomDialogGeneric(Activity activity, String key, OnButtonClickListener onButtonClickListener) {
        super(activity);
...
//            an.setFillAfter(true);               // keep rotation after animation
            ...
            return;
        } else setContentView(R.layout.custom_alert_dialog_generic_message);
    ...
    private void setupButtons() {
        ...
        btLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onButtonClickListener == null)
                    CustomDialogGeneric.this.dismiss();
                else onButtonClickListener.onLeftButtonClick(CustomDialogGeneric.this);
            }
        });
        btRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onButtonClickListener == null)
                    CustomDialogGeneric.this.dismiss();
                else onButtonClickListener.onRightButtonClick(CustomDialogGeneric.this, etNote.getText().toString().trim());
            }
        });
   ...
   /* public void setAlertImage(int alertImageID) {
    ...
    public interface OnButtonClickListener {
        void onLeftButtonClick(CustomDialogGeneric dialog);

        void onRightButtonClick(CustomDialogGeneric dialog, String notes);
    }
}
