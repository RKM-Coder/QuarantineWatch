...
public class CustomDialogGenericSOS extends Dialog {
    ...
    public CustomDialogGenericSOS(Activity activity, String key, OnButtonClickListener onButtonClickListener) {
        super(activity);
...
//            an.setFillAfter(true);               // keep rotation after animation
            ...
            return;
        } else setContentView(R.layout.custom_alert_dialog_generic_message_sos);
    ...
    private void setupButtons() {
        ...
        btLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onButtonClickListener == null)
                    CustomDialogGenericSOS.this.dismiss();
                else onButtonClickListener.onLeftButtonClick(CustomDialogGenericSOS.this);
            }
        });
        btRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onButtonClickListener == null)
                    CustomDialogGenericSOS.this.dismiss();
                else onButtonClickListener.onRightButtonClick(CustomDialogGenericSOS.this, etNote.getText().toString().trim());
            }
        });
   ...
   /* public void setAlertImage(int alertImageID) {
    ...
    public interface OnButtonClickListener {
        void onLeftButtonClick(CustomDialogGenericSOS dialog);

        void onRightButtonClick(CustomDialogGenericSOS dialog, String notes);
    }
}
