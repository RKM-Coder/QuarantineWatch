...
public class CustomDialogSOSdialog extends Dialog {
...
//    private EditText etNote;
    ...
    public CustomDialogSOSdialog(Activity activity, String key, OnButtonClickListener onButtonClickListener) {
        super(activity);
...
//            an.setFillAfter(true);               // keep rotation after animation
            ...
            return;
        } else setContentView(R.layout.activity_yelligo_arogya_mitra_dialog_alert);
    ...
    private void setupButtons() {
        ...
        imAlertImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onButtonClickListener == null)
                    CustomDialogSOSdialog.this.dismiss();
                else onButtonClickListener.onRightButtonClick(CustomDialogSOSdialog.this, "");
            }
        });
   ...
   /* public void setAlertImage(int alertImageID) {
    ...
    public interface OnButtonClickListener {
        void onLeftButtonClick(CustomDialogSOSdialog dialog);

        void onRightButtonClick(CustomDialogSOSdialog dialog, String notes);
    }
}
